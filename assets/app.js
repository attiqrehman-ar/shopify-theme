...
class Cart {
  constructor() {
    ...
    _defineProperty(this, "renderGiftWrapping", giftNode => {
      return fetchSection('cart-gift-wrapping').then(html => {
        const newGiftWrapping = html.querySelector("#shopify-section-cart-gift-wrapping").innerHTML;
        giftNode.innerHTML = newGiftWrapping;
  ...
  constructor(_ref) {
    ...
    _defineProperty(this, "changeMediaByVariant", variant => {
      ...
      if (this.mediaMode === 'slider') {
        ...
        if (img && src) {
          var _this$productData, _this$productData$ini3, _featuredImage$classL, _featuredImage$classL2;
          img.src = src;
          img.removeAttribute('srcset');
          const method = ((_this$productData = this.productData) === null || _this$productData === void 0 ? void 0 : (_this$productData$ini3 = _this$productData.initialVariant) === null || _this$productData$ini3 === void 0 ? void 0 : _this$productData$ini3.id) === (variant === null || variant === void 0 ? void 0 : variant.id) ? 'add' : 'remove';
...
// EXTERNAL MODULE: ./src/js/sections/product-tabs.js + 2 modules
var product_tabs = __webpack_require__(7555);
