...
class Eventable {
  ...
  on(name, fn) {
    ...
    (_this$_listeners$name = this._listeners[name]) === null || _this$_listeners$name === void 0 ? void 0 : _this$_listeners$name.push(fn);
...
class PhotoSwipeLightbox extends PhotoSwipeBase {
  ...
  _openPhotoswipe(module, uid) {
    ...
    Object.keys(this._listeners).forEach(name => {
      var _this$_listeners$name3;
      (_this$_listeners$name3 = this._listeners[name]) === null || _this$_listeners$name3 === void 0 ? void 0 : _this$_listeners$name3.forEach(fn => {
    ...
    Object.keys(this._filters).forEach(name => {
      var _this$_filters$name4;
      (_this$_filters$name4 = this._filters[name]) === null || _this$_filters$name4 === void 0 ? void 0 : _this$_filters$name4.forEach(filter => {
  ...
  destroy() {
    var _this$pswp4;
    (_this$pswp4 = this.pswp) === null || _this$pswp4 === void 0 ? void 0 : _this$pswp4.destroy();
    this.shouldOpen = false;
    this._listeners = {};
    getElementsFromOption(this.options.gallery, this.options.gallerySelector).forEach(galleryElement => {
  ...
  _doClickOrTapAction(actionName, point, originalEvent) {
    ...
    switch (optionValue) {
      ...
      case 'toggle-controls':
        (_this$gestures$pswp$e = this.gestures.pswp.element) === null || _this$gestures$pswp$e === void 0 ? void 0 : _this$gestures$pswp$e.classList.toggle('pswp--ui-visible');
        // if (_controlsVisible) {
        //   _ui.hideControls();
        // } else {
        //   _ui.showControls();
...
class photoswipe_esm_Eventable {
  ...
  dispatch(name, details) {
    ...
    const event = /** @type {AugmentedEvent<T>} */new photoswipe_esm_PhotoSwipeEvent(name, details);
    (_this$_listeners$name2 = this._listeners[name]) === null || _this$_listeners$name2 === void 0 ? void 0 : _this$_listeners$name2.forEach(listener => {
      listener.call(this, event);
    });
    return event;
...
class photoswipe_esm_Content {
  ...
  load(isLazy, reload) {
    ...
    if (this.isImageContent()) {
      this.element = photoswipe_esm_createElement('pswp__img', 'img');
      // Start loading only after width is defined, as sizes might depend on it.
      // Due to Safari feature, we must define sizes before srcset.
      if (this.displayedImageWidth) {
        this.loadImage(isLazy);
...
class ContentLoader {
  ...
  loadSlideByIndex(initialIndex) {
    ...
    if (!content) {
      ...
      content = photoswipe_esm_lazyLoadSlide(index, this.pswp);
...
class Opener {
  ...
  _applyStartProps() {
    ...
    if (this._animateZoom && this._thumbBounds && this._thumbBounds.innerRect) {
      var _this$pswp$currSlide2;
      // Properties are used when animation from cropped thumbnail
      this._croppedZoom = true;
      this._cropContainer1 = this.pswp.container;
      this._cropContainer2 = (_this$pswp$currSlide2 = this.pswp.currSlide) === null || _this$pswp$currSlide2 === void 0 ? void 0 : _this$pswp$currSlide2.holderElement;
      if (pswp.container) {
  ...
  _onAnimationComplete() {
    ...
    if (this.isClosed) {
      ...
      var _pswp$currSlide3;
      if (this._animateZoom && pswp.container) {
        pswp.container.style.overflow = 'visible';
        pswp.container.style.width = '100%';
      }
      (_pswp$currSlide3 = pswp.currSlide) === null || _pswp$currSlide3 === void 0 ? void 0 : _pswp$currSlide3.applyCurrentZoomPan();
    }
  }
...
class PhotoSwipe extends photoswipe_esm_PhotoSwipeBase {
  ...
  mouseDetected() {
    if (!this.hasMouse) {
      var _this$element3;
      this.hasMouse = true;
      (_this$element3 = this.element) === null || _this$element3 === void 0 ? void 0 : _this$element3.classList.add('pswp--has_mouse');
    }
  }
  ...
  _createMainStructure() {
    ...
    this.container = photoswipe_esm_createElement('pswp__container', 'div', this.scrollWrap);
